...
import egpio = require('./peripherals/edison/EdisonGpio');
import epwm = require('./peripherals/edison/EdisonPwm');
...
var pwmServo : epwm.EdisonPwm = new epwm.EdisonPwm(13);
pwmServo.open(20000); //20ms
// var pinServo = new mraa.Gpio(14); //=13
// pinServo.dir(mraa.DIR_OUT);

var pwmMotor : epwm.EdisonPwm = new epwm.EdisonPwm(12);
pwmMotor.open(1000);
